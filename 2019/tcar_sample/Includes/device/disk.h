 ...
 *
 *----------------------------------------------------------------------
 *    Modifications: Adapted to the TWR-X6x.
 *    Modified by UC Technology at 2014/06/24.
 *    Modifications: Adapted to the EVAL_STM32xx.
 *    Modified by UC Technology at 2014/07/04.
 *    Modifications: Adapted to the FRDM-K64F.
 *    Modified by UC Technology at 2015/07/28.
 *
 *    UCT micro T-Kernel Version 2.00.13
...
/* Start : MCU dependent */
#if defined(EVAL_STM3221G) || defined(EVAL_STM32437I) || defined(EVAL2_STM32439I)
#define DISK_DEVNM			"sda"
#elif defined(TWR_K60D100M) || defined(TWR_K60F120M) || defined(TWR_K70F120M) || defined(TWR_K60N512)
#define DISK_DEVNM			"sda"
